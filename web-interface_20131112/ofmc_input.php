...
<td valign="top">
	...
	<tr>
	  ...
	  <table>
          <tr>
          <td>
	    <input type="checkbox" name="sessco" <? if ($_POST['sessco']) echo "checked" ?>>
	  </td>
          <td>
	  ...
	  <td><input type="text" name="depth" value="<?=$_POST['depth']?>" size="5" maxlength="5" ></td>
	  </tr>
          <tr>
	  <td><font face="Arial, Helvetica, sans-serif" size="2">Path:</font></td>
	  <td><input type="text" name="path" value="<?=$_POST['path']?>" size="15" maxlength="25" ></td>
	  </tr>
          </table>
	  </p>
