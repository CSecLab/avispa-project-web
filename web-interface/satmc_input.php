	...
	<tr>
	  ...
	  <?php
	    ...
	    <area shape="rect" coords="7,141,71,164" href="ofmc_input.php?opened_file=<?php echo $_GET['opened_file'] ?>">
            ...
            <area shape="rect" coords="229,141,293,162" href="ta4sp_input.php?opened_file=<?php echo $_GET['opened_file'] ?>">
          </map>
	  <br>
          </td>
	  </form>
	  ...
	  <font face="Arial, Helvetica, sans-serif" size="2">
	   ...
	   <select  name="solver" size=1>
             <option value="chaff" <?php if($_POST['solver'] == "chaff") echo "selected" ?>>zChaff
             <option value="mchaff" <?php if($_POST['solver'] == "mchaff") echo "selected" ?>>mChaff
             <option value="sim" <?php if($_POST['solver'] == "sim") echo "selected" ?>>SIM
             <option value="sato" <?php if($_POST['solver'] == "sato") echo "selected" ?>>SATO
           </select>
	  </td>
          </tr>
	  <tr>
	  ...
	  <font face="Arial, Helvetica, sans-serif" size="2">
          ...
          <td>
	  <input type="text" name="depth" value="<?php echo $_POST['depth']?>" size="5" maxlength="5" >
	  </td>
          </tr>
          </table>
	  ...
	  <table>
          <tr>
          <td>
	    <input type="checkbox" name="mutex" <?php if ($_POST['mutex']) echo "checked" ?>>
	  </td>
          <td>
	  <font face="Arial, Helvetica, sans-serif" size="2">
	  ...
	  <tr>
          <td>
	    <input type="checkbox" name="ct" <?php if ($_POST['ct']) echo "checked" ?>>
	  </td>
          <td>
	  <font face="Arial, Helvetica, sans-serif" size="2">
	  Compound Types
	  ...
	  <tr>
          <td>
	  <input type="checkbox" name="oi" <?php if ($_POST['oi']) echo "checked" ?>>
	  </td>
          <td>
	  <font face="Arial, Helvetica, sans-serif" size="2">
	  Optimized Intruder
