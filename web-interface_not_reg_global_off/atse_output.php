...
if ($avispawebsetting == remote){
  ...
  $atse_cmd = "(ssh".$ssh_options.$remoteuser."@".$remoteip." ".
                     $remotewebinterfacepath.$bindir.$atse.$args.$remotewebinterfacepath.$opened_file.".if) > ".
...
elseif ($avispawebsetting == local)
{
  ...
  $atse_cmd = $bindir.$atse.$args.$localwebinterfacepath.$opened_file.".if > ".$localwebinterfacepath.$opened_file.".atse.atk";
} 
else 
...
<td valign="top">
	...
	><?php
          ...
          else
	  {
          ...
          if ($translation_ok) 
          {
            ...
            // Show Attack file
	    if (!readfile($opened_file.".atse.atk"))
              echo "File ".$opened_file.".atse.atk"." cannot be opened";
	...
	<!-- TextArea Buttons -->
	<a href=# onclick="window.open('showfile.php?file=<? echo $opened_file ?>&tool=atse','view_hlpsl','width=1000,height=600,left=12,top=84,menubar=0,status=0,location=0,toolbar=0,scrollbars=0,resizable=1');return(false)"><img src="images/view_hlpsl.gif" border="0"></a>
	...
	<?php
	  ...
	  {
	    // IF Button
	    echo "<a href=# onclick=\"window.open('showfile.php?file=".$opened_file.".if&tool=atse','view_if','width=1000,height=600,left=12,top=84,menubar=0,status=0,location=0,toolbar=0,scrollbars=0,resizable=0');return(false)\"><img src=\"images/view_if.gif\" border=\"0\"></a>\n"; 
