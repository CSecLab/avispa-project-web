...
<td valign="top">
	...
	<tr>
	  ...
	  <table>
          ...
          <input type="checkbox" name="two_agents_only" <? if ($_POST['two_agents_only']) echo "checked" ?>>
	  ...
	  <td align="left">
          ...
          <input type="radio" name="over_approx" <? if ($_POST['over_approx']) echo "checked" ?> onchange="UpdateRadio(2)">
	  <font face="Arial, Helvetica, sans-serif" size="2">Over-Approximation</font><br>
          <input type="radio" name="under_approx" <? if ($_POST['under_approx']) echo "checked" ?> onchange="UpdateRadio(1)">
	  ...
	  <input type="text" name="bound" value="<?=$_POST['bound']?>" size="2" maxlength="5" <? if (!$_POST['bound']) echo "disabled" ?>>
	  </td>
	  </tr>
