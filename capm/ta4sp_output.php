...
<td valign="top">
    ...
    <form name="forminput" method="post" action="ta4sp_input.php">
      ...
      <input type="hidden" name="two_agents_only" value=<?=$_POST['two_agents_only']?>>
      <input type="hidden" name="under_approx" value=<?=$_POST['under_approx']?>>
      <input type="hidden" name="over_approx" value=<?=$_POST['over_approx']?>>
      <input type="hidden" name="bound" value="<?=$_POST['bound']?>">
	...
	<!-- TextArea Buttons -->
	<a href=# onclick="window.open('showfile.php?file=<? echo $_POST['opened_file'] ?>&tool=ta4sp','view_hlpsl','width=1000,height=600,left=12,top=84,menubar=0,status=0,location=0,toolbar=0,scrollbars=0,resizable=1');return(false)"><img src="images/view_hlpsl.gif" border="0"></a>
	...
	?>
	<map name="Map">
         <area shape="rect" coords="7,141,71,164" href="ofmc_input.php?opened_file=<? echo $_POST['opened_file'] ?>">
