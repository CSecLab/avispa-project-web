...
my $http_ref = "http://www.avispa-project.org/download.html";
...
if ( $ENV{HTTP_REFERER} ne $http_ref ) {
	print <<END_OF_TEXT;
...
<html>
  ...
  Please refer to
  <a href=http://www.avispa-project.org>the AVISPA Project home page</a>
  from now on.<p>
