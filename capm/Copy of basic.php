...
@unlink ($_POST['opened_file'].".if");
@unlink ($_POST['opened_file'].".atse.atk");
@unlink ($_POST['opened_file'].".ofmc.atk");
@unlink ($_POST['opened_file'].".satmc.atk");
@unlink ($_POST['opened_file'].".ta4sp.atk");
...
<td valign="top">
    ...
    <form name="forminput" method="post" action="basic.php" accept="*.hlpsl" ENCTYPE="multipart/form-data">
	...
	<td valign="top" align="center" height="230" width="100%" colspan="3">
	 ...
	 ><?
	  ...
	  //echo "load_user_x=".$_POST['load_user_x']."\n";
          //echo "load_test_x=".$_POST['load_test_x']."\n";
          ...
          if ($_FILES['user_file'] && ($_POST['load_user_x'] != ""))
	  {
	    ...
	    if (substr($_POST['opened_file'],2, 7) != "tempdir")
	    {
	...
	<br><br>
      ...
      <!-- Help Center -->
      <form name="formoutput" method="post" action="basic_output.php?opened_file=<?=$_POST['opened_file']?>">
