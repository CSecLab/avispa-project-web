...
<td valign="top">
    ...
    <form name="forminput" method="post" action="satmc_input.php">
      ...
      <input type="hidden" name="enc" value="<?=$_POST['enc']?>">
	...
	<!-- TextArea Buttons -->
	<a href=# onclick="window.open('showfile.php?file=<? echo $_POST['opened_file'] ?>&tool=satmc','view_hlpsl','width=1000,height=600,left=12,top=84,menubar=0,status=0,location=0,toolbar=0,scrollbars=0,resizable=1');return(false)"><img src="images/view_hlpsl.gif" border="0"></a>
