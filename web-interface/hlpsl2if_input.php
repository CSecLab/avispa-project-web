...
<td valign="top">
  ...
  <td valign="top" align="center" width="33%" height="200">
    ...
    <table>
    <tr>
      <td><input type="checkbox" name="types" <?php if ($_POST['types']) echo "checked" ?>></td>
      <td><font size="2">Types section<br></font></td>
    </tr>
    <tr>
      <td><input type="checkbox" name="inits" <?php if ($_POST['inits']) echo "checked" ?>></td>
      <td><font size="2">Inits section<br></font></td>
    </tr>
    <tr>
      <td><input type="checkbox" name="rules" <?php if ($_POST['rules']) echo "checked" ?>></td>
      <td><font size="2">Rules section<br></font></td>
    </tr>
    <tr>
      <td><input type="checkbox" name="goals" <?php if ($_POST['goals']) echo "checked" ?>></td>
