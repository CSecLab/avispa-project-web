...
<td valign="top">
  ...
  <form name="forminput" method="post" action="hlpsl2if_input.php">
    ...
    ?>
      ...
      <a href=# onclick="window.open('showfile.php?file=<? echo $_POST['opened_file'] ?>','view_hlspl','width=1000,height=600,left=12,top=84,menubar=0,status=0,location=0,toolbar=0,scrollbars=0,resizable=1');return(false)"><img src="images/view_hlpsl.gif" border="0"></a>
      <br>      
      </td>
    </tr>
