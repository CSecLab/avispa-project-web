...
if ($_POST['depth'])  $args = $args."-d ".escapeshellarg($_POST['depth'])." ";
if ($_POST['path'])   $args = $args."-p ".escapeshellarg($_POST['path']). " ";
...
if ($avispawebsetting == remote){
  ...
  $ofmc_cmd = "(ssh".$ssh_options.$remoteuser."@".$remoteip." ".
                     ...
                     $remotewebinterfacepath.$_POST['opened_file'].".if ".escapeshellcmd($args).") > ".
...
<td valign="top">
    ...
    <form name="forminput" method="post" action="ofmc_input.php">
      ...
      <input type="hidden" name="sessco" value=<?php echo $_POST['sessco']?>>
...
?>&tool=ofmc','view_hlpsl','width=1000,height=600,left=12,top=84,menubar=0,status=0,location=0,toolbar=0,scrollbars=0,resizable=1');return(false)"><img src="images/view_hlpsl.gif" border="0"></a>
