...
@unlink ($_GET['opened_file'].".atse.atk");
@unlink ($_GET['opened_file'].".atse.png");
@unlink ($_GET['opened_file'].".atse.ps.gz");
...
<td valign="top">
	...
	<input type="hidden" name="algorithm" value="<?php echo $_POST['algorithm']?>">
	...
	<tr>
	  ...
	  <font face="Arial, Helvetica, sans-serif" size="2">
          <table>
          <tr>
          <td><input type="checkbox" name="ns" <?php if ($_POST['ns']) echo "checked" ?>></td>
          <td><font size="2">Simplify<br></font></td>
          </tr>
          <tr>
	  <td><input type="checkbox" name="notype" <?php if ($_POST['notype']) echo "checked" ?>></td>
          <td><font size="2">Untyped model<br></font></td>
          </tr>
          <tr>
	  <td><input type="checkbox" name="v" <?php if ($_POST['v']) echo "checked" ?>></td>
	  ...
	  <select  name="algorithm" size=1>
            <option value="td" <?php if($_POST['algorithm'] == "td") echo "selected" ?>>Depth first
            <option value="lr" <?php if($_POST['algorithm'] == "lr") echo "selected" ?>>Breadth first
          </select>
          </font>
	  </p>
