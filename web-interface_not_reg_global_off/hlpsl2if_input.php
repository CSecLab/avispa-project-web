...
<td valign="top">
  ...
  <td valign="top" align="center" width="33%" height="200">
    ...
    <table>
    <tr>
      <td><input type="checkbox" name="types" <? if ($types) echo "checked" ?>></td>
      <td><font size="2">Types section<br></font></td>
    </tr>
    <tr>
      <td><input type="checkbox" name="inits" <? if ($inits) echo "checked" ?>></td>
      <td><font size="2">Inits section<br></font></td>
    </tr>
    <tr>
      <td><input type="checkbox" name="rules" <? if ($rules) echo "checked" ?>></td>
      <td><font size="2">Rules section<br></font></td>
    </tr>
    <tr>
      <td><input type="checkbox" name="goals" <? if ($goals) echo "checked" ?>></td>
