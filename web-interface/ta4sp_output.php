...
// Constructing arguments list that will be passed to TA4SP
$args=" ";

if ($_POST['two_agents_only']) 
  $args=$args."--2AgentsOnly ";

$args=$args."--level=".$_POST['bound'];

if ($avispawebsetting == remote)
  $args=$args." --output=".$remotewebinterfacepath.$tempdir;
else
  $args=$args." --output=".$localwebinterfacepath.$tempdir;
    
  
// Constructing command line calls to the tools
if($avispawebsetting == remote){
  ...
  $ta4sp_cmd = "(ssh".$ssh_options.$remoteuser."@".$remoteip." ".
                      ...
                      $localwebinterfacepath.$_POST['opened_file'].".ta4sp.atk";
...
elseif ($avispawebsetting == local)
{
  ...
  $ta4sp_cmd = $bindir.$ta4sp." ".
               $localwebinterfacepath.$_POST['opened_file'].".if ".$args." > ".
               $localwebinterfacepath.$_POST['opened_file'].".ta4sp.atk";
} 
else 
...
function Summary($atk_file)
{
  ...
  // Search for the ".ta4sp.atk"SUMMARY keyword inside the file
  $found = false;
...
<td valign="top">
    ...
    <form name="forminput" method="post" action="ta4sp_input.php">
	  ...
	  // Call the tools on the workfile
	    ...
	    $hlpsl2if_output = shell_exec($hlpsl2if_cmd);
          ...
          if ($translation_ok) 
          {
            ...
            // Show Attack file
	    if (!readfile($_POST['opened_file'].".ta4sp.atk"))
              echo "File ".$_POST['opened_file'].".ta4sp.atk"." cannot be opened";
...
?>&tool=ta4sp','view_hlpsl','width=1000,height=600,left=12,top=84,menubar=0,status=0,location=0,toolbar=0,scrollbars=0,resizable=1');return(false)"><img src="images/view_hlpsl.gif" border="0"></a>
	...
	<?php
	  ...
	  {
	    // IF Button
	    echo "<a href=# onclick=\"window.open('showfile.php?file=".$_POST['opened_file'].".if&tool=ta4sp','view_if','width=1000,height=600,left=12,top=84,menubar=0,status=0,location=0,toolbar=0,scrollbars=0,resizable=0');return(false)\"><img src=\"images/view_if.gif\" border=\"0\"></a>\n"; 
	    
	    // MSC and PS Buttons
	    $ta4sp_summary = Summary($_POST['opened_file'].".ta4sp.atk");
	    if ($ta4sp_summary=="UNSAFE")
	    {
	      echo "<a href=# onclick=\"window.open('showfile.php?image=".$_POST['opened_file'].".ta4sp.atk&tool=ta4sp','ta4sp_msc','width=1000,height=600,left=12,top=84,menubar=0,status=0,location=0,toolbar=0,scrollbars=1,resizable=0');return(false)\"><img src=\"images/view_msc.gif\" border=\"0\"></a>\n";
	      
	      echo "<a href=# onclick=\"window.open('showfile.php?ps=".$_POST['opened_file'].".ta4sp.atk&tool=ta4sp','ta4sp_ps','width=500,height=300,left=262,top=234,menubar=0,status=0,location=0,toolbar=0,scrollbars=1,resizable=0');return(false)\"><img src=\"images/view_ps.gif\" border=\"0\"></a>\n";
	...
	<?php 
	  if ($translation_ok)
	    echo "<img src=\"images/trace_ta4sp.gif\" border=\"0\" usemap=\"#Map\">\n";
	  else
