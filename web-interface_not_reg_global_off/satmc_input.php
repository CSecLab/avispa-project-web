...
@unlink ($opened_file.".satmc.png");
@unlink ($opened_file.".satmc.ps.gz");
	...
	<tr>
	  ...
	  <font face="Arial, Helvetica, sans-serif" size="2">
	   ...
	   <select  name="solver" size=1>
             <option value="chaff" <? if($solver == "chaff") echo "selected" ?>>zChaff
             <option value="mchaff" <? if($solver == "mchaff") echo "selected" ?>>mChaff
             <option value="sim" <? if($solver == "sim") echo "selected" ?>>SIM
             <option value="sato" <? if($solver == "sato") echo "selected" ?>>SATO
           </select>
	  </td>
          </tr>
	  <tr>
	  ...
	  <font face="Arial, Helvetica, sans-serif" size="2">
          ...
          <td>
	  <input type="text" name="depth" value="<?=$depth?>" size="5" maxlength="5" >
	  </td>
          </tr>
          </table>
	  ...
	  <table>
          <tr>
          <td>
	    <input type="checkbox" name="mutex" <? if ($mutex) echo "checked" ?>>
	  </td>
          <td>
	  <font face="Arial, Helvetica, sans-serif" size="2">
	  ...
	  <tr>
          <td>
	    <input type="checkbox" name="ct" <? if ($ct) echo "checked" ?>>
	  </td>
          <td>
	  <font face="Arial, Helvetica, sans-serif" size="2">
	  Compound Types
	  ...
	  <tr>
          <td>
	  <input type="checkbox" name="oi" <? if ($oi) echo "checked" ?>>
	  </td>
          <td>
	  <font face="Arial, Helvetica, sans-serif" size="2">
	  Optimized Intruder
